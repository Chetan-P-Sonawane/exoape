       ...
       <div className="w-full absolute top-0">
        <div className=' text max-w-screen-xl h-full mx-auto px-7 sm:px-14 text-white'>
          <div className='para mt-72 sm:mt-[29rem]'>
            <p className='text-[3.4vw] sm:text-[1.56vw] tracking-[0.5px] font-semibold '>Global digital design studio partnering with</p>
            <p className='text-[3.4vw] sm:text-[1.56vw] tracking-[0.5px] font-semibold '>brands and businesses that create exceptional</p>
            <p className='text-[3.4vw] sm:text-[1.56vw] tracking-[0.5px] font-semibold '>experiences where people live, work, and unwind.</p>
          </div>
